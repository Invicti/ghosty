...
ARG GHOSTY_VERSION
ARG mailtrain_url
ARG mailtrain_configuration_id_as_int
ARG mailtrain_host
...
ENV mailtrain_url=$mailtrain_url
ENV mailtrain_configuration_id_as_int=$mailtrain_configuration_id_as_int
ENV mailtrain_host=$mailtrain_host
ENV NGROK=$ENV_NGROK
ENV GHOSTY_VERSION=$GHOSTY_VERSION
